...
?>
					...
					<?php $nr++;}?>
						...
						<tr>
							<td colspan="3">
								<button type="submit" name="singleStudentBill" id="submitbill" class="btn btn-primary" style="float: right;"><span class="glyphicon glyphicon-send"></span>  Submit</button>
							</td>
						</tr>
					</tbody>
					</table>
