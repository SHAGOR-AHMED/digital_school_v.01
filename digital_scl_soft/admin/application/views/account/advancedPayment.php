            ...
            <div class="panel panel-default" style="margin-top:20px;">
                <div class="panel-body">
                    ...
                    <!-- account/advancePaymentEntry -->
                        <form class="form-horizontal" role="form" action="account/advancePaymentEntry" method="post" onsubmit="return validateFrm();" >
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select name="year" id="advYear" class="form-control" onchange="htmlData('index.php/account_billgenerate/advanceFeeGet','shift='+shiftRepo.value+'&ch='+classidrepo.value+'&section='+sectionsrepo.value+'&roll='+rollidrepo.value+'&year='+this.value)" >
                                        <option value="">Select</option>
