...
-->
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" action="account_billgenerate/singleStdBillGen" method="post">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select name="month" id="SingleMonth" class="form-control" onchange="singlehtmlData('index.php/account_billgenerate/singleStdFee','shift='+SingleShift.value+'&ch='+SingleClassidrepo.value+'&section='+SingleSectionsrepo.value+'&roll='+rollidrepo.value+'&month='+this.value)" >
                                        <option value="">Select</option>
