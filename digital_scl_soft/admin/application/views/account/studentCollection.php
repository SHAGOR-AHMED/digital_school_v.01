...
<?php
	if(isset($_POST['invSearch'])):
		...
		<div class="panel panel-success col-md-offset-2 col-md-8">
			...
			<form action="account/studentBillPayment" method="post">
				<table width="130px" style="float:right;margin-top:50px;margin-right:-50px;">
					<tr>
						<td>Amount :
							<input name="payment" id="payment" type="text" onkeypress="return isNumber(event)" class="form-control" onchange="calculateDue(this.value,totalBill.value)" required />
					...
					<tr>
						<td>
							<button type="submit" name="pay" id="pay" class="btn btn-primary" style="float:right;">Submit</button>
						</td>
					</tr>
				</table>
			</form>
