		...
		<div class="container-fluid">
			...
			<!-- <div class="panel-heading"><p id="title">Examination Name Entry</p></div> -->
		  	        <!-- <div class="panel-body"> -->
		    	        <form action="index.php/account_billgenerate/addSchoolerShip" method="post" class="form-inline">
                            <table class="table">
                               <?php
                               ...
                               ?>
                                ...
                                <tr>
                                    <td>Roll No :</td>
                                    <td>
                                        <input type="text" name="roll" id="roll" class="form-control" required style="width:180px;float:left;" onkeypress="return isNumber(event)" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Waver ( % ) :</td>
                                    <td>
                                        <input type="text" name="waver" id="waver" class="form-control" required style="width:180px;float:left;" onkeypress="return isNumber(event)" />
                                    </td>
                                </tr>
                        ...
                        <td style="width:15%;"></td>
                            ...
                            <td>
                                <button type="submit" name="schoolerShip" class="btn btn-primary" >
