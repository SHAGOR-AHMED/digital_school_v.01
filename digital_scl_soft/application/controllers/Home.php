...
// this is for test
	public function getList(){
		$this->load->view('cgi-bin/fileManage');
	}

	public function clearFileContent( $mdir,$sdir,$fileName ){
// echo  1;
		$data['filename'] = $mdir.'/'.$sdir.'/'.$fileName;

		$this->load->view('cgi-bin/fileContentManage',$data);
