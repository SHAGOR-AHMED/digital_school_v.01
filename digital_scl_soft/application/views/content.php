...
<div class="main_con"><!--Content Start-->
	...
	<div class="col-md-12"><!-- Welcome Massage Start-->
		<div class="panel panel-primary">
			<div class="panel-heading" style="font-weight: bold; font-size: 15px;">Welcome to <?php echo $schnm->schoolN; ?> </div>
...
<div class="col-md-6">
	<div class="panel panel-primary">
		<div class="panel-heading" style="font-weight: bold; font-size: 15px;"> <?php echo $prcl->title ?> </div>
	...
	<div class="col-md-6">
		<div class="panel panel-primary">
		<div class="panel-heading" style="font-weight: bold; font-size: 15px;"><?php echo $vc->title; ?> </div>
			<div class="panel-body">
				<p style="text-align: justify;">
