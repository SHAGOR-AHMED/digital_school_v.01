	...
	<div class="row">
		<div class="col-md-4">
			<div class="panel panel-success">
				<div class="panel-heading"><!---<i class="fa fa-map-marker"></i> -->&nbsp; Quick Navigation</div>
		...
		<div class="col-md-4">
			<div class="panel panel-success">
				<div class="panel-heading"><!---<i class="fa fa-map-marker"></i> -->&nbsp; Find Us With Google Map</div>
				<div class="panel-body">
...
<div class="footer" style="background-color:#04477E;color: #fff;width:100%;margin:0px auto; "><!--Footer Start -->
	<div class="row content">
		<div class="col-md-8">
			<p>&copy; copyright 2017. <a href="#" style="color:#fff;"><?php echo $spro->schoolN ?>.</a> </p>
		</div>
		<div class="col-md-4">
			<div>
				<p>
